...
namespace App.Extensions
{
    ...
    public class DesabilitaElementoByClaimTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            output.Attributes.Add(new TagHelperAttribute("title", "Você não tem esta permissão"));
        }
    ...
    public class DesabilitaLinkByActionTagHelper : TagHelper
    {
        private readonly IHttpContextAccessor _contextAccessor;

        public DesabilitaLinkByActionTagHelper(IHttpContextAccessor contextAccessor)
        {
            _contextAccessor = contextAccessor;
        }
